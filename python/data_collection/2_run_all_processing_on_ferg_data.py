""""
This file runs all of the processing steps on the data as I did it exactly
for the paper.

To run this for your own data, check out run_identity_extractor.py in the
examples directory of Twitter_dm ... its almost exactly the same script except
that it is more straightforward to use with a new dataset
"""
